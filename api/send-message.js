export default async function handler(req, res) {
  ...
  try {
    ...
    // NÃO registra no Inbox aqui: o webhook recebe o eco de toda mensagem
    // enviada (manual e automática) com o message_id correto e registra.
    // Isso evita duplicatas (send-message + eco do webhook).
