module.exports = async function handler(req, res) {
  ...
  const PROMPTS_SIMULACAO = {
    ...
    alinhamento: PREFIXO_PRECISO + "Clearly straighten and align any crooked, rotated, or unevenly spaced teeth — a genuine, visible correction as if a full course of orthodontic treatment was completed. Teeth should look properly aligned, evenly spaced and naturally positioned, similar to a real orthodontic result. Keep natural tooth shape, size and color unchanged — only correct the alignment/position." + SUFIXO_PRESERVAR,
    ...
    protese: PREFIXO_PRECISO + "Fill in the visible gaps from missing teeth with natural, well-proportioned replacement teeth that match the color, shape and alignment of the surrounding natural teeth — creating a genuinely complete, healthy-looking, natural smile. The added teeth should look real and integrated, not obviously prosthetic or artificially uniform." + SUFIXO_PRESERVAR,
    gengivoplastia: PREFIXO_PRECISO + "Moderately adjust the gum line to be more even and proportional, visibly reducing an excessive or uneven gum display ('gummy smile') for a more balanced smile — a real, noticeable but natural-looking correction, not extreme." + SUFIXO_PRESERVAR,
...
const PROMPTS_SIMULACAO = {
  ...
  alinhamento: "Clearly straighten and align any crooked, rotated, or unevenly spaced teeth — a genuine, visible correction as if a full course of orthodontic treatment was completed. Teeth should look properly aligned, evenly spaced and naturally positioned, similar to a real orthodontic result. Keep natural tooth shape, size and color unchanged — only correct the alignment/position",
  lentes: "Perform a genuine, clearly visible cosmetic dental veneer transformation: correct the size and proportions of the teeth to be more ideal and harmonious, refine the shape of any uneven or worn teeth to look symmetric and well-proportioned, correct visible misalignments and close visible gaps, and remove chips or irregular edges. Whiten the teeth to a bright, attractive white — clearly and visibly whiter and more uniform than the original, similar to a real cosmetic veneer result from a good dentist. The result must be a REAL, NOTICEABLE improvement (not subtle or barely-there) while still looking like genuine human teeth with natural enamel texture and realistic light reflection — a believable, professional clinical result, not a cartoon smile, denture, or artificial-looking filter",
  protese: "Fill in the visible gaps from missing teeth with natural, well-proportioned replacement teeth that match the color, shape and alignment of the surrounding natural teeth — creating a genuinely complete, healthy-looking, natural smile. The added teeth should look real and integrated, not obviously prosthetic or artificially uniform",
  gengivoplastia: "Moderately adjust the gum line to be more even and proportional, visibly reducing an excessive or uneven gum display ('gummy smile') for a more balanced smile — a real, noticeable but natural-looking correction, not extreme",
