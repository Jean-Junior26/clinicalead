module.exports = async function handler(req, res) {
  ...
  const PROMPTS_SIMULACAO = {
    ...
    protese: PREFIXO_PRECISO + "Fill in ONLY the specific visible gap(s) from missing teeth, adding a replacement tooth/teeth that closely match the EXACT current color, shade, size and wear of this specific person's OWN remaining natural teeth (not an idealized bright white — match their real, current tooth color and condition precisely, even if slightly yellowed, worn, or uneven). CRITICAL: do NOT whiten, straighten, reshape, or otherwise change any of the person's OTHER existing teeth — every other tooth must remain EXACTLY as it appears in the original photo, unchanged. Only the missing tooth gap should be filled; the rest of the smile must stay pixel-identical to the original." + SUFIXO_PRESERVAR,
...
const PROMPTS_SIMULACAO = {
  ...
  protese: "Fill in ONLY the specific visible gap(s) from missing teeth, adding a replacement tooth/teeth that closely match the EXACT current color, shade, size and wear of this specific person's OWN remaining natural teeth (not an idealized bright white — match their real, current tooth color and condition precisely, even if slightly yellowed, worn, or uneven). CRITICAL: do NOT whiten, straighten, reshape, or otherwise change any of the person's OTHER existing teeth — every other tooth must remain EXACTLY as it appears in the original photo, unchanged. Only the missing tooth gap should be filled; the rest of the smile must stay pixel-identical to the original",
